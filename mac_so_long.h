...
/*   Updated: 2024/03/08 08:58:20 by heltayb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef MAC_SO_LONG_H
# define MAC_SO_LONG_H
...
//error related to arguments and maps (mac_error_arguments.c)
...
//error related to map path (mac_error_map_path.c)
...
//error related to map (mac_error_map.c)
...
//movement of the image depends on the player position (mac_image_move_player.c)
...
//moving the image and game initilize (mac_image_movements.c)
...
//map_initilize and helping functions (mac_map_initilize.c)
...
//player movements functions (mac_player_movements.c)
...
//the main file contain the main function (mac_so_long.c)
